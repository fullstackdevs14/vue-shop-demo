...
This demo shows how to accept payments with stripe. This is built with Vue.js and the backend is built with a
serverless function. The shop also shows how a number of concepts work in Vue. Server side rendering and routing is done
